      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <svg className="animate-spin" width="32" height="32" viewBox="0 0 40 40" fill="none">
          <path d="M20 4C11.2 4 4 11.2 4 20s7.2 16 16 16 16-7.2 16-16S28.8 4 20 4z"
            stroke="#B5ADA0" strokeWidth="1" fill="none"/>
          <path d="M20 10c-5.5 0-10 4.5-10 10s4.5 10 10 10 10-4.5 10-10-4.5-10-10-10z"
            stroke="#B5ADA0" strokeWidth="1" fill="none" opacity="0.6"/>
          <circle cx="20" cy="20" r="3" fill="#B5ADA0" opacity="0.4"/>
        </svg>
        <span className="text-ink-faint text-[12px] tracking-widest uppercase">Loading</span>
      </div>
    </div>
  )
}
